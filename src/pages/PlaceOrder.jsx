      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            <div className="flex items-center gap-3 border p-2 px-2 cursor-pointer" onClick={()=>setMethod('cod')}>
            <p className={`min-w-3.5 h-3.5 border rounded-full ${method==="cod" ? 'bg-green-400' : ""}`}></p>
            <p className="text-gray-500 text-sm font-medium mx-6">CASH ON DELIVERY</p>
            </div>
          </div>
